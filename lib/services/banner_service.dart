...
class BannerService extends ChangeNotifier {
  List<model.Banner> getBanners() {
    ...
    return [
      model.Banner(id: 1, imageUrl: 'https://placehold.co/600x300/F4D7D7/FFFFFF?text=Ad+Banner+1'),
      model.Banner(id: 2, imageUrl: 'https://placehold.co/600x300/F4D7D7/FFFFFF?text=Ad+Banner+2'),
    ];
  }
}